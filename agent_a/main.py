        ...
        try:
            ...
            if not description:
                template_descriptions = {
                    ...
                    "nlp-data-analytics": "Разработка полноценного веб-приложения для анализа данных через естественный язык. Пользователь загружает CSV/Excel файлы или подключает локальную БД, после чего может задавать текстовые вопросы на человеческом языке для получения аналитики, графиков и статистики"
                }
