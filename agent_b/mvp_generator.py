    ...
    async def _create_project_from_template(self, template_id: str, project_name: str, description: str):
        ...
        template_critical_files_map = {
            ...
            "api-services": [
                ...
                "pages/api/wayback/analyze-complete.js",
                "pages/api/wayback/analyze-complete-status.js",
                ...
                "src/lib/adapters/wayback/backlinkAnalyzer.js",
                "src/lib/adapters/wayback/metricsAnalyzer.js",
                "src/lib/adapters/wayback/topicAnalyzer.js",
                "src/components/wayback/BacklinkAnalysisPanel.js",
                "src/components/wayback/DomainMetricsPanel.js",
                "src/components/wayback/DomainRecommendationsTable.js",
                "src/components/wayback/TopicAnalysisPanel.js",
                "vercel.json", 
                "next.config.js"
            ],
