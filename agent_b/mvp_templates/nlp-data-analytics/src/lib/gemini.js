...
1. СТАТИСТИЧЕСКИЙ АНАЛИЗ:
   - Базовые метрики: среднее (mean), медиана (median), минимум, максимум, сумма, количество
   - Для числовых колонок автоматически вычисляются все метрики
   - Используй type: "statistics" для запросов типа "покажи статистику", "средние значения", "базовая статистика"
...
Верни ТОЛЬКО валидный JSON в формате:
{
  ...
  "statistics": ["mean", "median", "count", "min", "max"] (если type = "statistics", укажи какие метрики нужны),
  "visualization": {
